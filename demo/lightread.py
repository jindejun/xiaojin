...
driver.find_element_by_css_selector('#NAME').send_keys(u'测试1108')
...
Select(s).select_by_value('308')
group = driver.find_element_by_css_selector("#MOBILE_GROUP>[value='308']").text
# print(group)
js = 'document.getElementById("SEND_TIME").removeAttribute("readonly")'
driver.execute_script(js)
driver.find_element_by_id('SEND_TIME').send_keys('2018-11-08 16:54')
time.sleep(1)
driver.find_element_by_id('SEND_TIME').click()
js1 = 'document.getElementById("REISSUE_TIME").removeAttribute("readonly")'
driver.execute_script(js1)
driver.find_element_by_id('REISSUE_TIME').send_keys('2018-11-08 16:56')
time.sleep(1)
